...
def load_confs(confs_path=os.getcwd() + '/ResumeParser/confs/config.yaml'):
    # TODO Docstring
    global CONFS

    print(os.getcwd() + '/ResumeParser/confs/config.yaml')
...
def archive_dataset_schemas(step_name, local_dict, global_dict):
    ...
    # Reference variables
    data_schema_dir = os.getcwd() + '/ResumeParser/data/schema'
