...
def extract():
    ...
    for root, subdirs, files in os.walk(os.getcwd() + '/ResumeParser/data/input/example_resumes'):
...
def load(observations, nlp):
    ...
    output_path = os.path.join(os.getcwd() + '/ResumeParser/data/output/resume_summary.csv')
